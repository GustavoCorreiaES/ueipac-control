...
class UEIPACWidget(_QWidget):
    ...
    def config_ueipac(self):
        ...
        try:
            ...
            file = open("C:/Users/labimas/Desktop/ueipac-control/ueipac/gui/input.txt", 'w')
        ...
        Returns:
            ...
            self.localpath = "C:/Users/labimas/Desktop/ueipac-control/ueipac/gui/input.txt"
            self.sftp = self.ssh.open_sftp()
            ...
            if self.ui.cmb_mode.currentIndex() == 1:
                ...
                if self.ui.cmb_plot.currentIndex() == 0:
                    ...
                    for i in range(self.y2):
                        self.canvas.axes.plot(self.f2[0:self.x2//2], self.voltage_abs2[0:self.x2//2, i], label = "Channel {}" .format(self.n))
                ...
                if self.ui.cmb_plot.currentIndex() == 0:
                    for i in range(self.y):
                        self.canvas.axes.plot(self.f[0:self.x//2], self.voltage_abs[0:self.x//2, i], label = "Channel {}" .format(self.n))
